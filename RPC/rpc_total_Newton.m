function [y_out,n_rpc,d_rpc,n_iterations] = rpc_total_Newton(x_train,y_train,x_out,order,polynomial,preprocessing_parameter,regularization_parameter,tol)
switch polynomial
    case "Hermite"
        f = @genHermite;
    case "Legendre"
...
di = zeros(n_total,1);
for i = 1:n_y
    [n_rpc(:,i),d_rpc(:,i),n_iterations(i)] = Newton_solve(Phi,y_train(:,i),ni,di,tol,100,regularization_parameter);
    % n_rpc(:,i) = ni;
    % d_rpc(:,i) = di;
end
