...
y = zeros(d,1);
for i = 1:n_y
    [x,y,training_err(i),test_err(i),n_iterations(i)] = TT_Newton_rational6(training_samples,x,training_out(:,i),y,r_max,tol,max_iterations,vali_samples,vali_out(:,i),lambda2);
