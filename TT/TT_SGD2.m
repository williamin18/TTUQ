function [x_min,training_err,test_err,n_iterations] = TT_SGD2(A,b,x,r_round,tol,max_epoches,A_test,b_test,lambda,batch_size)
...
for epoch = 1:max_epoches
    ...
    for j = 1:batch_size:n_samples-batch_size+1
        ...
        r_j = b_j- multi_r1_times_TT(A_j,x);
        df = multi_r1_times_vec_to_TT(A_j,r_j);
        Adf = multi_r1_times_TT(A,df);
