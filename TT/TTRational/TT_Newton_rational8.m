function [x,y,training_err,test_err,epoch] = TT_Newton_rational8(A,x,b,y,rank,tol,max_iterations,A_test,b_test,lambda)
...
for epoch = 1:max_iterations
    ...
    r = b - multi_r1_times_TT(A,x)./(1+C*y);
    test_r1 =  norm(r);
    
    %Compute Newton updates for each core
    [V,dUx,y] = TT_Newton_Gradient_rational2(A,C,x,y,r,beta,dx_TT,lambda);
    ...
    x =TT_rounding_ALS4(A,x2,b+Cb*y,rank,lambda);
