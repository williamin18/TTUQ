function [x,y,training_err,test_err,epoch] = TT_Newton_rational_r1d2(A,x,b,y,rank,tol,max_iterations,A_test,b_test,lambda)
...
for epoch = 1:max_iterations
    ...
    r = b.*Cy_r1(C,y) - multi_r1_times_TT(A,x);
    test_r1 =  norm(r);
    
    %Compute Newton updates for each core
    [V,dUx,y] = TT_Newton_Gradient_rational_r1d2(A,C,b,x,y,r,beta,dx_TT,lambda);
