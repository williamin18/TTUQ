...
m = 1;
xi_train = training_samples2(1000:2000,:);
y_train = vouts_train2(1000:2000,:);

% [y_predict2,n_rpc,d_rpc] = rpc_total(xi_train,y_train(:,100),test_samples,3,'Hermite',0.3,0.1,5e-3);
